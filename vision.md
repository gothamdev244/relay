...
The vision of Relay is to be an open source layer for your integrations.
...
- Dynamic plugin support
  Run plugins in a v8 isolate, let your agent write whatever it needs, ship instructions as part of relay
- Integrations registry
- Configure relay via relay
...
The focus of Relay should be to ship the primitives that build an extendable product. Everything needs to be written with that in mind
