...
import CreateExecutor from "/snippets/sdk/quickstart/create-relay.mdx";
...
import CloseExecutor from "/snippets/sdk/quickstart/close-relay.mdx";
...
```bash npm
npm install @relay-js/sdk @relay-js/plugin-openapi
```

```bash pnpm
pnpm add @relay-js/sdk @relay-js/plugin-openapi
```

```bash yarn
yarn add @relay-js/sdk @relay-js/plugin-openapi
```

```bash bun
bun add @relay-js/sdk @relay-js/plugin-openapi
```
