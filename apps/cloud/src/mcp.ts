...
const AUTHKIT_DOMAIN = env.MCP_AUTHKIT_DOMAIN ?? "https://signin.relay.sh";
const RESOURCE_ORIGIN = env.MCP_RESOURCE_ORIGIN ?? "https://relay.sh";
...
>()("@relay-sh/cloud/McpOrganizationAuth") {}
