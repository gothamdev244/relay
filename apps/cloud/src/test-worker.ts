...
const handleSeedOrg = async (
  ...
  // oxlint-disable-next-line relay/no-try-catch-or-throw -- boundary: worker seed endpoint keeps postgres cleanup in native async finalization
  try {
    ...
    // oxlint-disable-next-line relay/no-promise-catch -- boundary: best-effort postgres close during worker seed endpoint cleanup
