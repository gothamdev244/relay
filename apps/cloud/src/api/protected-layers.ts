...
import { CoreHandlers, composePluginApi, composePluginHandlerLayer } from "@relay-sh/api/server";
...
// which has the right ordering to provide `AuthContext` AND the relay
