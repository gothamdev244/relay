...
//        → Core OAuthHandlers → relay.oauth.start / complete
//        → MCP SDK `auth()`
...
import { ScopeId } from "@relay-sh/sdk";
import { serveOAuthTestServer, type OAuthTestServerShape } from "@relay-sh/sdk/testing";
