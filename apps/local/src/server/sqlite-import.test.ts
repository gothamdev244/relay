...
import { importLegacySqliteIfNeeded, readBundledDrizzleMigrationHashes } from "./relay";
...
beforeEach(() => {
  workDir = mkdtempSync(join(tmpdir(), "relay-sqlite-import-"));
  sqlite = null;
});
...
const lateSchema = {
  late_item: scopedRelayTable("late_item", {
...
const legacyShapeSchema = {
  legacy_shape: scopedRelayTable("legacy_shape", {
