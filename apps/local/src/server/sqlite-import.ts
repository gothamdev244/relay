...
/* oxlint-disable relay/no-json-parse, relay/no-switch-statement, relay/no-try-catch-or-throw -- boundary: one-shot legacy SQLite importer normalizes unknown rows and wraps native sqlite failures */

import { type AnyColumn, type AnyTable, type FumaTables } from "@relay-sh/sdk";
