...
description: Route HTTP through Effect boundaries instead of raw fetch. Use when lint flags relay/no-raw-fetch or when adding networked protocol/provider code.
