...
const toIssueMessage = (error: ErrorObject): string => {
  ...
  // oxlint-disable-next-line relay/no-unknown-error-message -- typed AJV ErrorObject exposes optional validation message copy
...
export const standardSchemaFromJsonSchema = (
  ...
  // oxlint-disable-next-line relay/no-try-catch-or-throw -- boundary: AJV compile throws for invalid schemas and this adapter preserves fallback behavior
  try {
