 ...
 * `Data.TaggedError` subclass — e.g. `CodeRelay<WorkerLoaderError>`.
 */
export interface CodeRelay<E extends Cause.YieldableError = CodeExecutionError> {
