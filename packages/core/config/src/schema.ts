...
export const McpAuthConfig = Schema.Union([
  ...
  Schema.Struct({
     ...
     *  via the relay's innermost-wins lookup. */
...
// dynamic sibling of the static `relay.config.ts` plugin tuple — when
...
export const RelayFileConfig = Schema.Struct({
...
export type RelayFileConfig = typeof RelayFileConfig.Type;
