...
import { OAUTH_POPUP_MESSAGE_TYPE, type OAuthPopupResult } from "@relay-sh/sdk";

export { OAUTH_POPUP_MESSAGE_TYPE, isOAuthPopupResult } from "@relay-sh/sdk";
export type { OAuthPopupResult } from "@relay-sh/sdk";
