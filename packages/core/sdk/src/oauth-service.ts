...
// ---------------------------------------------------------------------------
// Service dependencies — the relay wires these up when it constructs
...
const safeHostname = (value: string | null): string | null => {
  ...
  // oxlint-disable-next-line relay/no-try-catch-or-throw -- boundary: URL constructor is the platform parser; non-URL labels remain display labels
  try {
