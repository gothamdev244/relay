...
// relay stitches them into `tools.list`, `tools.invoke`, and the public
// `relay.policies` CRUD surface. Plugins consume the same surface.
// ---------------------------------------------------------------------------
