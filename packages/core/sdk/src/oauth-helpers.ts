...
export const assertSupportedOAuthEndpointUrl = (
  ...
  // oxlint-disable-next-line relay/no-try-catch-or-throw, relay/no-error-constructor -- boundary: synchronous assertion helper used by URL constructors and Effect.try wrappers
