...
// ---------------------------------------------------------------------------
// Plugin extension — public API on relay.fileSecrets
// ---------------------------------------------------------------------------
...
// arg passed from the relay's secrets facade.
//
// `list` enumerates the innermost scope the provider was configured
// for — the relay's fallback/list path passes scope separately but
...
// and both are called once per createRelay.
// ---------------------------------------------------------------------------
