...
import { InternalError, ScopeId, SecretBackedMap } from "@relay-sh/sdk/shared";
...
//
// 5xx is handled at the API level: `CoreRelayApi.addError(InternalError)`
...
// OAuth errors live on the shared `/oauth/*` group in `@relay-sh/api`
