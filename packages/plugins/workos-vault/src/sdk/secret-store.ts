...
const DEFAULT_OBJECT_PREFIX = "relay";
...
export const workosVaultSchema = {
  workos_vault_metadata: scopedRelayTable("workos_vault_metadata", {
...
export interface WorkOSVaultSecretProviderOptions {
  ...
  /**
   * Build the vault `context` map from an relay scope id. Each key
