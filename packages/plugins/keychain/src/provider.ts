...
import { StorageError, type SecretProvider } from "@relay-sh/sdk/core";
...
const toStorageError = (cause: KeychainError) => {
  ...
  // oxlint-disable-next-line relay/no-unknown-error-message -- boundary: typed KeychainError message becomes StorageError message
