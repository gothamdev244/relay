...
import { definePlugin, type PluginCtx, type SecretProvider } from "@relay-sh/sdk/core";
...
// isn't actually reachable. Writing is the capability the relay
...
export interface KeychainPluginConfig {
  /** Override the keychain service name (default: "relay") */
  readonly serviceName?: string;
}

// ---------------------------------------------------------------------------
// Plugin extension — public API on relay.keychain
// ---------------------------------------------------------------------------
