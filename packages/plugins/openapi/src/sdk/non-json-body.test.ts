...
describe("OpenAPI non-JSON request body dispatch", () => {
  ...
  it.effect("application/xml: string body passes through with xml content-type", () =>
    Effect.gen(function* () {
      ...
      yield* relay.tools.invoke("xml.body.submit", { body: xml }, autoApprove);
  ...
  it.effect("text/xml: object body is JSON-stringified (never '[object Object]')", () =>
    Effect.gen(function* () {
      ...
      yield* relay.tools.invoke("tx.body.submit", { body: { name: "Acme" } }, autoApprove);
  ...
  it.effect("text/plain: string body passes through with text/plain", () =>
    Effect.gen(function* () {
      ...
      yield* relay.tools.invoke("tp.body.submit", { body: "hello, world" }, autoApprove);
  ...
  it.effect("application/octet-stream: Uint8Array passes through as bytes", () =>
    Effect.gen(function* () {
      ...
      yield* relay.tools.invoke("bin.body.submit", { body: payload }, autoApprove);
  ...
  it.effect("multi-content: defaults to first-declared (not JSON-first)", () =>
    Effect.gen(function* () {
      ...
      yield* relay.tools.invoke("mc.body.submit", { body: { name: "Acme" } }, autoApprove);
