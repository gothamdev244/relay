...
// `Layer.succeed(OpenApiExtensionService, withCapture(relay.openapi))`.
...
const RelayApiWithOpenApi = addGroup(OpenApiGroup);
...
export const OpenApiHandlers = HttpApiBuilder.group(RelayApiWithOpenApi, "openapi", (handlers) =>
  handlers
