...
// `Layer.succeed(GraphqlExtensionService, withCapture(relay.graphql))`.
...
const RelayApiWithGraphql = addGroup(GraphqlGroup);
...
export const GraphqlHandlers = HttpApiBuilder.group(RelayApiWithGraphql, "graphql", (handlers) =>
  handlers
