...
// ---------------------------------------------------------------------------
// Register a parsed manifest against the relay core + plugin storage.
...
export const googleDiscoveryPlugin = definePlugin(() => ({
  ...
  packageName: "@relay-sh/plugin-google-discovery",
  ...
  // the api-aware factory in `@relay-sh/plugin-google-discovery/api`.
