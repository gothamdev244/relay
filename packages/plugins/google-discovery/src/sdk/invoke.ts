...
import type { PluginCtx, StorageFailure } from "@relay-sh/sdk/core";
...
const errorMessageFromUnknown = (cause: unknown): string => {
  ...
  // oxlint-disable-next-line relay/no-unknown-error-message -- boundary: preserves existing fallback text for HTTP client errors
  return String(cause);
};
