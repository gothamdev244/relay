...
// ---------------------------------------------------------------------------
// Schema — plugin-declared tables merged with coreSchema at relay start.
// ---------------------------------------------------------------------------

export const googleDiscoverySchema = {
  google_discovery_source: scopedRelayTable("google_discovery_source", {
  ...
  google_discovery_source_credential_header: scopedRelayTable(
  ...
  google_discovery_source_credential_query_param: scopedRelayTable(
  ...
  google_discovery_binding: scopedRelayTable("google_discovery_binding", {
    source_id: textColumn("source_id"),
