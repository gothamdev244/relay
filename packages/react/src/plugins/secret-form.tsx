...
import { SecretId, type ScopeId } from "@relay-sh/sdk/shared";
...
function useSecretForm(): SecretFormContextValue {
  ...
  if (!ctx) {
    // oxlint-disable-next-line relay/no-try-catch-or-throw, relay/no-error-constructor -- boundary: React context invariant surfaces programmer misuse during render
