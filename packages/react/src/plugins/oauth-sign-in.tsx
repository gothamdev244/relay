...
const getDesktopBridge = (): DesktopBridge | null => {
  ...
  const candidate = (window as { readonly relay?: Partial<DesktopBridge> }).relay;
  return candidate && typeof candidate.openExternal === "function"
    ? // oxlint-disable-next-line relay/no-double-cast -- boundary: narrowed by the typeof guard above
