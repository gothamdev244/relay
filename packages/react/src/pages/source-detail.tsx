...
import { effectivePolicyFromSorted } from "@relay-sh/sdk/shared";
import {
...
export function SourceDetailPage(props: { namespace: string }) {
  ...
  useEffect(() => {
    ...
    import.meta.hot.on("relay:backend-updated", refresh);
    return () => {
      import.meta.hot?.off("relay:backend-updated", refresh);
    };
