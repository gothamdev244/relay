...
import { RelayApi } from "@relay-sh/api/client";
...
const electronBasicHeader = (): string | null => {
  ...
  // The Electron sidecar uses Basic auth with the literal username "relay"
  // and a session-generated password injected at preload time.
  return `Basic ${globalThis.btoa(`relay:${password}`)}`;
};

const RelayApiClient = AtomHttpApi.Service<"RelayApiClient">()("RelayApiClient", {
  api: RelayApi,
